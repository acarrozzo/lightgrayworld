  ...
  return (
    <div className="mt-2 border-t border-gray-700/60 pt-4 pb-2">
      ...
      <div className="space-y-2">
        {levelUp && (
          <div className="flex items-center justify-center gap-3 rounded-md bg-yellow-500/10 border border-yellow-500/30 px-3 py-2">
        ...
        {xpReward && (
          <div className="flex items-center justify-center gap-3 rounded-md bg-gray-800/60 px-3 py-2">
