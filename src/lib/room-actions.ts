...
export const ROOM_ACTIONS: Record<string, RoomAction[]> = {
  ...
  '004': [],
  '005': [
    { action: 'pick blueberry', label: 'Pick Blueberry', icon: 'blueberry', className: 'fill-hue-blue' },
  ],
  '012d': [
  ...
  '020': [
    { action: 'rest at waterfall', label: 'Rest at Waterfall', icon: 'heal', className: 'fill-hue-blue' },
  ...
  '015': [
    ...
    { action: 'mine stone', label: 'Mine Stone', icon: 'beach-rock', className: 'fill-surface-selected' },
  ],
  '016': [
    { action: 'shovel sand', label: 'Shovel Sand', icon: 'shovel', className: 'fill-hue-gold' },
  ],
  ...
  '999': [
    { action: 'rest in lobby', label: 'Rest at the Fountain', icon: 'heal', className: 'fill-hue-green' },
    { action: 'teleport to grassy field', label: 'Teleport to the Grassy Field', icon: 'world', className: 'fill-hue-green' },
  ],
  ...
  '118': [
    { action: 'talk to hunter bill', label: 'Hunter Bill', icon: 'npc-hunterbill', className: 'fill-hue-green', questIds: questIdsForNpc('hunter_bill') },
    { action: 'rest at camp', label: "Rest at Bill's Camp", icon: 'heal', className: 'fill-hue-blue' },
  ],
  '119': [
    { action: 'open gold chest', label: 'Open Gold Chest', icon: 'chest', className: 'fill-mood-treasure' },
  ],
  '128': [
    { action: 'talk to forest gnome', label: 'Forest Gnome', icon: 'npc-forestgnome', className: 'fill-hue-green', questIds: questIdsForNpc('forest_gnome') },
  ],
  ...
  '221': [
    { action: 'talk to the people', label: 'Town Hall Plaza', icon: 'npc-townhallplaza', className: 'fill-hue-red', questIds: questIdsForNpc('town_hall_plaza') },
  ],
  '222': [
    { action: 'talk to mayor', label: 'Mayor Rudolf', icon: 'npc-mayor', className: 'fill-hue-red', questIds: questIdsForNpc('mayor_rudolf') },
  ],
  '224': [
    { action: 'pick flower', label: 'Pick Flower', icon: 'flower', className: 'fill-hue-gold' },
    { action: 'open gold chest', label: 'Open Gold Chest', icon: 'chest', className: 'fill-mood-treasure' },
  ],
  '225': [
  ...
  '229': [
    { action: 'view shop', label: 'View Shop', icon: 'steak', className: 'fill-mood-treasure' },
  ],
  '236': [
    { action: 'view shop', label: 'View Shop', icon: 'shop', className: 'fill-surface-selected' },
  ],
  '237': [
    { action: 'view shop', label: 'View Stables', icon: 'tent', className: 'fill-mood-treasure' },
  ],
  ...
  '232o': [
    { action: 'open treasure chest', label: 'Open Treasure Chest', icon: 'chest', className: 'fill-mood-treasure' },
  ],
  '232x': [
    { action: 'rest at oasis', label: 'Rest at the Oasis', icon: 'heal', className: 'fill-hue-blue' },
  ],
  '232y': [
    { action: 'open gray chest', label: 'Open Gray Chest', icon: 'chest2', className: 'fill-surface-selected' },
  ],
  '232z': [
...
for (let depth = 1; depth <= 30; depth += 1) {
  ...
  ROOM_ACTIONS[roomId] = [
    ...(ROOM_ACTIONS[roomId] ?? []),
    { action: 'mine here', label: 'Mine Here', icon: 'pickaxe', className: 'fill-mood-treasure' },
  ]
}
