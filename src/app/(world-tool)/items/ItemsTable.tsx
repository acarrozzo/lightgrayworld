    ...
    <div>
          ...
          <button
            ...
            className={`rounded px-3 py-1 text-sm border transition-colors ${
              tab === t
                ...
                : 'border-line-subtle/80 fill-surface-panel text-fg-secondary hover:border-line-subtle hover:text-fg-bright'
            }`}
          >
            {t}
          </button>
      ...
      <div className="mb-4 flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="rounded border border-line-subtle/80 fill-surface-panel px-3 py-1 text-sm text-fg-secondary/80 transition-colors hover:border-line-subtle hover:text-fg-bright disabled:cursor-default disabled:opacity-40 disabled:hover:border-line-subtle disabled:hover:text-fg-secondary"
        >
          Reset view
        </button>
