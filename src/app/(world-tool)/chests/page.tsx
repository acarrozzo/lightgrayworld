...
// Templates and room names for every chest, cached in production: see
// lib/world-tool/cached.ts.
const loadChestData = cachedWorldToolData('chests', () =>
  Promise.all([
    slugs.length
...
export default async function ChestsPage() {
  const [templates, rooms] = await loadChestData()
