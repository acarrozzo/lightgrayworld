...
What are you doing reading a sign at a time like this! 
Don't you know this place is swarming with sand crabs! 
It's never safe.
So why you don't you attack some for a little while and collect that sweet loot.
And when you are done, use the grassyfield teleport from the WORLD MENU to get out of here easy.
...
// -------------------------------------------------------------------------- TRAVEL
elseif ($input == 'north') {    $roomNum = '018';handleTravel($_SESSION['username'], $link, 'north', $roomNum, 'desc'.$roomNum.'');} 
elseif ($input == 'northeast') { 
    ...
    updateStats($link, $username, ['room' => '003c']); // -- update stats
...
//  updateStats($link, $username, ['endfight' => 0]); // -- update stats - MAKES ROOM NEVER SAFE!
