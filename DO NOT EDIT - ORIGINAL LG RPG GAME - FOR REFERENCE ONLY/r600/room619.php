...
if ($infight < 1 && $endfight != 1) {  // RAND GENERATOR
    ...
    if (($rand == 1) && $infight==0 && $endfight==0) {
        ...
        updateStats($link, $username,['enemy' => 'Gatekeeper' ]); // -- set enemy
        include('battle.php');
    }
...
// -------------------------------------------------------------------------- TRAVEL
elseif ($input == 'east') {     $roomNum = '618';handleTravel($_SESSION['username'], $link, 'east', $roomNum, 'desc'.$roomNum.'');}
elseif ($input == 'west') {     $roomNum = '620';handleTravel($_SESSION['username'], $link, 'west', $roomNum, 'desc'.$roomNum.'');}
