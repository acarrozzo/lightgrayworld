...
if(($rand == 1 ) && $infight==0 && $endfight==0 || $input == 'attack') 
	{	
	// $results = $link->query("UPDATE $user SET enemy = 'Troll Queen'");
	updateStats($link, $username,['enemy' => 'Troll Queen' ]); // -- set enemy
	include ('battle.php'); 
}				
...
elseif ($input == 'northeast') { $roomNum = '523';handleTravel($_SESSION['username'], $link, 'northeast', $roomNum, 'desc'.$roomNum.'');
	$_SESSION['emptytree'] = 0; // reset tree
	}
elseif ($input == 'southeast') { $roomNum = '520';handleTravel($_SESSION['username'], $link, 'southeast', $roomNum, 'desc'.$roomNum.'');
	$_SESSION['emptytree'] = 0; // reset tree
	}
elseif ($input == 'southwest') { $roomNum = '518';handleTravel($_SESSION['username'], $link, 'southwest', $roomNum, 'desc'.$roomNum.'');
	$_SESSION['emptytree'] = 0; // reset tree
	}
elseif ($input == 'northwest') { $roomNum = '522';handleTravel($_SESSION['username'], $link, 'northwest', $roomNum, 'desc'.$roomNum.'');
	$_SESSION['emptytree'] = 0; // reset tree
	}
