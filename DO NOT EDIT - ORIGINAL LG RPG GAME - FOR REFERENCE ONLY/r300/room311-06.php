...
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['desc311-06'];
...
{			echo 'You travel up the mine<br>';
   	$message="<i class=''>You travel up the mine</i><br>".$_SESSION['desc311-05'];
	include ('update_feed.php'); // --- update feed
...
{		
		if ($pickaxe<=0 && $ironpickaxe<=0 && $steelpickaxe<=0 && $mithrilpickaxe<=0) {
			...
			echo 'You dig down to mine level 7.<br>';
   			$message="<i class=''>You dig down to mine level 7.</i><br>".$_SESSION['desc311-07'];
			include ('update_feed.php'); // --- update feed
