...
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['desc311-02'];
...
{			
	...
	$message="<i class=''>You travel up the mine</i><br>".$_SESSION['desc311-01'];
	include ('update_feed.php'); // --- update feed
...
{		
	if ($pickaxe<=0 && $ironpickaxe<=0 && $steelpickaxe<=0 && $mithrilpickaxe<=0) {
		...
		$message="<i class=''>You dig down to mine level 3.</i><br>".$_SESSION['desc311-03'];
		include ('update_feed.php'); // --- update feed
