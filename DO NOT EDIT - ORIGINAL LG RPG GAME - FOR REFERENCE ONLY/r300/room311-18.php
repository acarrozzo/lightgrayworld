...
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['desc311-18'];
...
{			echo 'You travel up the mine<br>';
   	$message="<i class=''>You travel up the mine</i><br>".$_SESSION['desc311-17'];
	include ('update_feed.php'); // --- update feed
...
{		
		if ($pickaxe<=0 && $ironpickaxe<=0 && $steelpickaxe<=0 && $mithrilpickaxe<=0) {
			...
			echo 'You dig down to mine level 19.<br>';
   			$message="<i class=''>You dig down to mine level 19.</i><br>".$_SESSION['desc311-19'];
			include ('update_feed.php'); // --- update feed
