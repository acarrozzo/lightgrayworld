...
$lookdesc = $_SESSION['lookdesc'] = $_SESSION['desc311-29'];
...
// -------------------------------------------------------------------------- IN BATTLE	
    ...
    elseif ($input=='u' || $input=='up') {
        ...
        $message="<i class=''>You travel up the mine</i><br>".$_SESSION['desc311-28'];
        include('update_feed.php'); // --- update feed
        ...
        if ($pickaxe<=0 && $ironpickaxe<=0 && $steelpickaxe<=0 && $mithrilpickaxe<=0) {
            ...
            $message="<i class=''>You dig down to mine level 30.</i><br>".$_SESSION['desc311-30'];
            include('update_feed.php'); // --- update feed
