...
{	if ($equipMount == 'wooden boat')
    ...
    updateStats($link, $username,['endfight' => 0, 'room' => '407' ]); // -- update stats
        ...
        elseif ($_SESSION['flying'] >= '1') {
            ...
            $message="<i>You fly west! </i><br>".$_SESSION['desc407'];
            include('update_feed.php'); // --- update feed
			// $results = $link->query("UPDATE $user SET room = '407'"); // -- room change
    updateStats($link, $username,['endfight' => 0, 'room' => '407' ]); // -- update stats
        } 
...
{	if ($equipMount == 'wooden boat')
    ...
    updateStats($link, $username,['endfight' => 0, 'room' => '405' ]); // -- update stats
        ...
        elseif ($_SESSION['flying'] >= '1') {
            ...
            $message="<i>You fly south! </i><br>".$_SESSION['desc405'];
            include('update_feed.php'); // --- update feed
			// $results = $link->query("UPDATE $user SET room = '405'"); // -- room change
    updateStats($link, $username,['endfight' => 0, 'room' => '405' ]); // -- update stats
        } 
...
{	if ($equipMount == 'wooden boat')
    ...
    updateStats($link, $username,['endfight' => 0, 'room' => '401' ]); // -- update stats
        ...
        elseif ($_SESSION['flying'] >= '1') {
            ...
            $message="<i>You fly northeast! </i><br>".$_SESSION['desc401'];
            include('update_feed.php'); // --- update feed
			// $results = $link->query("UPDATE $user SET room = '401'"); // -- room change
    updateStats($link, $username,['endfight' => 0, 'room' => '401' ]); // -- update stats
        } 
...
{	if ($equipMount == 'wooden boat')
    ...
    updateStats($link, $username,['endfight' => 0, 'room' => '403' ]); // -- update stats
        ...
        elseif ($_SESSION['flying'] >= '1') {
            ...
            $message="<i>You fly east! </i><br>".$_SESSION['desc403'];
            include('update_feed.php'); // --- update feed
			// $results = $link->query("UPDATE $user SET room = '403'"); // -- room change
    updateStats($link, $username,['endfight' => 0, 'room' => '403' ]); // -- update stats
        } 
