...
{	if ($equipMount == 'wooden boat')
    ...
    updateStats($link, $username,['endfight' => 0, 'room' => '423' ]); // -- update stats
        ...
        elseif ($_SESSION['flying'] >= '1') {
            ...
            $message="<i>You fly west! </i><br>".$_SESSION['desc423'];
            include('update_feed.php'); // --- update feed
			// $results = $link->query("UPDATE $user SET room = '423'"); // -- room change
    updateStats($link, $username,['endfight' => 0, 'room' => '423' ]); // -- update stats
        } 
...
{	if ($equipMount == 'wooden boat')
    ...
    updateStats($link, $username,['endfight' => 0, 'room' => '424' ]); // -- update stats

		}
        elseif ($_SESSION['flying'] >= '1') {
            echo 'You fly southwest!<br>';
            $message="<i>You fly southwest! </i><br>".$_SESSION['desc424'];
            include('update_feed.php'); // --- update feed
			// $results = $link->query("UPDATE $user SET room = '424'"); // -- room change
    updateStats($link, $username,['endfight' => 0, 'room' => '424' ]); // -- update stats
        } 
...
{	if ($equipMount == 'wooden boat')
    ...
    updateStats($link, $username,['endfight' => 0, 'room' => '420' ]); // -- update stats
        ...
        elseif ($_SESSION['flying'] >= '1') {
            ...
            $message="<i>You fly northeast! </i><br>".$_SESSION['desc420'];
            include('update_feed.php'); // --- update feed
			// $results = $link->query("UPDATE $user SET room = '420'"); // -- room change
    updateStats($link, $username,['endfight' => 0, 'room' => '420' ]); // -- update stats
        } 
...
{	if ($equipMount == 'wooden boat')
    ...
    updateStats($link, $username,['endfight' => 0, 'room' => '419' ]); // -- update stats

		}
        elseif ($_SESSION['flying'] >= '1') {
            echo 'You fly east!<br>';
            $message="<i>You fly east! </i><br>".$_SESSION['desc419'];
            include('update_feed.php'); // --- update feed
			// $results = $link->query("UPDATE $user SET room = '419'"); // -- room change
    updateStats($link, $username,['endfight' => 0, 'room' => '419' ]); // -- update stats
        } 
...
{	if ($equipMount == 'wooden boat')
    ...
    updateStats($link, $username,['endfight' => 0, 'room' => '418' ]); // -- update stats
        ...
        elseif ($_SESSION['flying'] >= '1') {
            ...
            $message="<i>You fly southeast! </i><br>".$_SESSION['desc418'];
            include('update_feed.php'); // --- update feed
			// $results = $link->query("UPDATE $user SET room = '418'"); // -- room change
    updateStats($link, $username,['endfight' => 0, 'room' => '418' ]); // -- update stats
        } 
