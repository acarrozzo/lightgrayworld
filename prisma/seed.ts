...
async function main() {
  ...
  const rooms = [
    ...
    },
    {
      roomId: '003c',
      name: 'Young Soldier',
      subtitle: 'A training yard for eager recruits.',
      subtitlePosition: 'below',
      description: 'A young soldier has set up a small training ground beside the cabin. Practice dummies and weapon racks line the yard, and the air rings with the sound of steel.',
      dangerLevel: 0,
      isSafe: true,
      north: null,
      south: null,
