...
async function main() {
  ...
  const rooms = [
    ...
    },
    {
      ...
      icon: 'skull',
      iconColor: 'red-900',
      description: 'The pit floor writhes with scorpions. The walls are slick with venom and the air is thick and suffocating. A ledge high above marks the only way back out.',
      dangerLevel: 5,
      isSafe: false,
      north: null,
      south: null,
