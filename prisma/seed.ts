...
async function main() {
  ...
  const rooms = [
    ...
    },
    {
      roomId: '999',
      name: 'The Lobby',
      subtitle: 'Grand Forum of the Multitude',
      subtitlePosition: 'above',
      nameColor: 'amber-300',
      subtitleColor: 'amber-100',
      icon: 'world',
      iconColor: 'amber-400',
      description: 'You stand in awe within a magnificent grand forum, a testament to the glory of Greco-Roman classical architecture. Soaring marble columns, each carved with intricate Doric, Ionic, and Corinthian capitals, rise to support a vast coffered ceiling adorned with golden rosettes. The floor beneath your feet is a masterpiece of geometric mosaic, depicting scenes of heroic deeds and divine intervention. Sunlight streams through arched windows, casting ethereal beams that illuminate the polished marble surfaces. At the center of this celestial space, a grand fountain cascades with crystalline waters, its basin surrounded by statues of legendary figures. The air itself seems to shimmer with an otherworldly radiance, and the acoustics of this hallowed hall carry whispers of the multitude who have gathered here throughout the ages. This is a place of congregation, of wonder, where adventurers from all corners of the realm converge to share tales and seek new horizons.',
      dangerLevel: 0,
      isSafe: true,
      north: null,
      south: null,
