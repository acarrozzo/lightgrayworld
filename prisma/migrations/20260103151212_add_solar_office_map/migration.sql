-- CreateEnum
CREATE TYPE "ItemType" AS ENUM ('WEAPON', 'EQUIPMENT', 'CONSUMABLE', 'MISC');
...
CREATE TABLE "User" (
    ...
    "solarOfficeMap" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "KillList" (
    ...
    CONSTRAINT "KillList_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Room" (
    ...
    "subtitle" TEXT NOT NULL DEFAULT 'This is it. The world is yours.',
    "subtitlePosition" TEXT NOT NULL DEFAULT 'below',
    "nameColor" TEXT,
    "subtitleColor" TEXT,
    "icon" TEXT,
    "iconColor" TEXT,
    "directionColors" JSONB,
...
CREATE TABLE "ActionCap" (
    ...
    CONSTRAINT "ActionCap_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ItemTemplate_slug_key" ON "ItemTemplate"("slug");

-- CreateIndex
CREATE INDEX "ActionCap_playerId_roomId_idx" ON "ActionCap"("playerId", "roomId");

-- CreateIndex
CREATE UNIQUE INDEX "ActionCap_playerId_roomId_actionKey_key" ON "ActionCap"("playerId", "roomId", "actionKey");

-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_currentRoom_fkey" FOREIGN KEY ("currentRoom") REFERENCES "Room"("roomId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "KillList" ADD CONSTRAINT "KillList_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RoomItem" ADD CONSTRAINT "RoomItem_roomId_fkey" FOREIGN KEY ("roomId") REFERENCES "Room"("roomId") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RoomItem" ADD CONSTRAINT "RoomItem_templateId_fkey" FOREIGN KEY ("templateId") REFERENCES "ItemTemplate"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "NPC" ADD CONSTRAINT "NPC_roomId_fkey" FOREIGN KEY ("roomId") REFERENCES "Room"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PlayerItem" ADD CONSTRAINT "PlayerItem_playerId_fkey" FOREIGN KEY ("playerId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PlayerItem" ADD CONSTRAINT "PlayerItem_templateId_fkey" FOREIGN KEY ("templateId") REFERENCES "ItemTemplate"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ActionCap" ADD CONSTRAINT "ActionCap_playerId_fkey" FOREIGN KEY ("playerId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
