...
async function main() {
  ...
  const rooms = [
    ...
    {
      roomId: '001',
      name: 'DEV Grassy Field Crossroads',
    ...
    },
    {
      ...
      subtitlePosition: 'below',
      description:
        'A young soldier has set up a small training ground beside the cabin. Practice dummies and weapon racks line the yard, and the air rings with the sound of steel.',
      dangerLevel: 0,
      isSafe: true,
      north: null,
      south: null,
